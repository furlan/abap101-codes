...
CLASS xml_document DEFINITION CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create_from_scratch RETURNING VALUE(xml_object) TYPE REF TO xml_document.

    CLASS-METHODS create_from_file  IMPORTING filename          TYPE string
                                    RETURNING VALUE(xml_object) TYPE REF TO xml_document.
...
CLASS xml_document IMPLEMENTATION.
  ...
  METHOD constructor.
    " defaul initialization code goes here...
  ENDMETHOD.

  METHOD create_from_scratch.
    CREATE OBJECT xml_object. "create object and return.
  ENDMETHOD.

  METHOD create_from_file.
    CREATE OBJECT xml_object. "create object from file and return.
  ENDMETHOD.

  METHOD create_from_stream.
    CREATE OBJECT xml_object. "create object from stream and return.
  ENDMETHOD.
ENDCLASS.
